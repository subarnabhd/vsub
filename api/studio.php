...
<body>
  ...
  <main>
    <div class="s-banner d-nav">
      <a href="#white-head" class="s-icon scroll-down"><i class="fa-solid fa-arrow-down-long"></i></a>

      <div class="container s-conatin">
        <img src="./image/studio/tss.svg" />
        <h2>The Subarna Studio</h2>

        <a href="https://studio.subarnabhandari.com/">studio.subarnabhandari.com</a>
      </div>
      <div class="s-icons row">
        <a href="https://www.facebook.com/TheSubarnaStudio" class="s-icon" target="_blank"><i
            class="fab fa-facebook-f"></i></a>
        <a href="https://www.instagram.com/TheSubarnaStudio" class="s-icon" target="_blank"><i
            class="fab fa-instagram"></i></a>
        <a href="https://www.linkedin.com/company/TheSubarnaStudio" class="s-icon" target="_blank"><i
    ...
    <div class="tss-3 d-nav">
      <div class="container">
        ...
        <div class="card-deck">
          ...
          <div class="card dbox">
            <img src="/image/studio/format-circle.webp" class="tss-img-top" alt="..." />
    ...
    <div class="tss-foot row d-nav">
      <div class="container">
        <div class="row">
          ...
          <a href="mailto:thesubarnastudio@gmail.com">thesubarnastudio@gmail.com</a>
        </div>
      </div>
    </div>
  </main>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="left">
              <ul>
                ...
                <li>
                  <a href="/studio.html" class="modal-dot">Studio<strong>.</strong></a>
                </li>
                <li>
            ...
            <div class="center">
              <ul>
                ...
                <li>
                  <a target="_blank" href="https://read.cv/subarnabhd" class="modal-sm-dot">Resume</a>
                </li>
                ...
                <li>
                  <a target="_blank" href="http://pay.subarnabhandari.com/" class="modal-sm-dot">Pay</a>
                </li>
              </ul>
            </div>
            <div class="right">
          ...
          <div class="modal-footer">
            <div class="modal-container">
              <div class="left">
                <li>
                  <a target="_blank" href="https://facebook.com/subarnabhd" class="m-foot-link">Facebook</a>
                </li>
                <li>
                  <a target="_blank" href="https://instagram.com/subarnabhd" class="m-foot-link">Instagram</a>
                </li>
                <li>
                  <a target="_blank" href="https://www.linkedin.com/in/subarnabhd" class="m-foot-link">Linkedin</a>
                </li>
                <li>
                  <a target="_blank" href="https://twitter.com/subarnabhd" class="m-foot-link">Twitter</a>
                </li>
                <li>
                  <a target="_blank" href="https://behance.net/subarnabhd" class="m-foot-link">Behance</a>
                </li>
                <li>
                  <a target="_blank" href="https://dribbble.com/subarnabhd" class="m-foot-link">Dribbble</a>
                </li>
                <li>
                  <a target="_blank" href="/link.html" class="m-foot-link">More..</a>
                </li>
              </div>
              <div class="right">
                <li>
                  <a target="_blank" href="mailto:hello@subarnabhandari.com">hello@subarnabhandari.com</a>
                </li>
              </div>
            </div>
          </div>
