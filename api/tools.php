...
<head>
  ...
  <meta name="google-site-verification" content="TbzXTnkzw3f5cx146NDpru1FSImbZ6gjn0yGLgbmSD4" />
  ...
  <meta name="keywords" content="tools, Subarna, simplify tasks, productivity, Subarna Tools" />
  <meta name="author" content="Subarna Bhandari" />

  <!-- Favicon -->
  <link rel="shortcut icon" href="./image/tools/tfavi.webp" />
  ...
  <!-- Google Icon Font -->
  <link rel="stylesheet"
    href="https://fonts.googleapis.com/css2?family=Material+Icons+Outlined:wght@400;700&display=swap" />
      ...
      <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active" data-bs-interval="5000">
            <img src="./image/tools/banner1.webp" class="d-block w-100 m-0" alt="...">
          </div>

          <div class="carousel-item" data-bs-interval="10000">
            <img src="./image/tools/banner2.webp" class="d-block w-100 m-0" alt="...">
          ...
          <div class="carousel-item" data-bs-interval="20000">
            <img src="./image/tools/banner3.webp" class="d-block w-100 m-0" alt="...">
            <div class="carousel-caption d-none d-md-block">
      ...
      <div class="row toolsrow">
        <div class="col-md-3 rows ficol ">
          <div class="datecard dbox ">
              ...
              <div id="time">11:50:35 </div>
              <div id="amPm">AM</div>
              <div id="DATE_IN_NEPALI">२०८० माघ २०, शनिबार </div>
              <div id="date">
                <div id="date-day">Saturday</div>
                <div id="date-date">February 3, 2024</div>
              </div>
          ...
          <div class="popbar">
            ...
            <a class="poplink dbox" href="date.html" type="button">
              <div class="popbutton">
                <img src="/image/date/dfavi.webp" />
                <p class="popname">Date. by Subarna</p>
              </div>
              <i class="fa-solid popico fa-chevron-right"></i>
            </a>
            <a class="poplink dbox" href="unicode.html" type="button">
              <div class="popbutton">
                <img src="/image/tools/convert.webp" />
            ...
            <a class="poplink dbox"
              ...
              <div class="popbutton">
                <img src="/image/tools/chrome.webp" />
            ...
            <a class="poplink dbox" href="https://pay.subarnabhandari.com" type="button" target="_blank">
              <div class="popbutton">
                <img src="/image/pay/subarnapay.webp" />
            ...
            <a class="poplink dbox" href="https://subarnabhd.notion.site/Mac-App-d526415b61784b24938a1e21ed539e06?pvs=4"
              type="button" target="_blank">
              <div class="popbutton">
                <img src="/image/tools/appstore.webp" />
            ...
            <a class="poplink dbox"
              ...
              type="button" target="_blank">
              <div class="popbutton">
                <img src="/image/tools/notion.webp" />
          ...
          <div class="usefullink">
            ...
            <div class="ubox ">
              <a class="ulink dbox col" href="https://appstorrent.ru" type="button" target="_blank">Appstorrent
                [mac]</a>
              <a class="ulink dbox col" href="https://haxmac.cc/" type="button" target="_blank">Haxmac [mac]</a>
              <a class="ulink dbox col" href="https://getintopc.com/" type="button" target="_blank">Getintopc
                [windows]</a>
        ...
        <div class="col-md-9 secol">
          ...
          <div class="row rows rowpad w-100 m-auto">
            ...
            <a class="bhdbutton dbox col" href="date.html" type="button">
              <div class="cbutton">
                <img src="/image/date/dfavi.webp" />
                <p class="c1name">Date. by Subarna</p>
            ...
            <a class="bhdbutton dbox col" href="http://www.ipo.bhandarisubarna.com.np/" type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/ipo.webp" />
                <p class="c1name">Bulk IPO Reult</p>
                <p class="c2name">Meroshare</p>
              </div>
            </a>

            <a class="bhdbutton dbox col" href="https://chromewebstore.google.com/detail/days-since-days-count/llfehbiaaelkldaefaaeannhecgabpgd" type="button" target="_blank">
              <div class="cbutton">
                <img src="https://lh3.googleusercontent.com/fARTNIYdav2O4ZD7IV-ZvMNoQnLPyUz1BEyZJjHRmpkOsh0OhGqMTTn11pFw43vr_OwFmoYa66ZuvqpDmWwVTzDY=s60" />
                <p class="c1name">Days Since</p>
                <p class="c2name">Chrome Extension</p>
              </div>
            </a>

            <a class="bhdbutton dbox col" href="https://chrome.google.com/webstore/detail/hoifffakgghpghnnnohmhbnokfjjedhl" type="button" target="_blank">
              <div class="cbutton">
                <img src="https://lh3.googleusercontent.com/fsuIq0fzPgB5MIIUTgNuciJfRfWpcjbLO6XqghqHZrqEnO9hp9DmxssJT6UQRcaJtvMoWXPUdDqipaNThgM1vpFp=s60" />
                <p class="c1name">Days Until</p>
                <p class="c2name">Chrome Extension</p>
              </div>
            </a>

            <a class="bhdbutton dbox col" href="https://chromewebstore.google.com/detail/youtube-search/pfbenbknnmnppacheleigdmlhgllhlpa" type="button" target="_blank">
              <div class="cbutton">
                <img src="https://lh3.googleusercontent.com/2u6rKv7Rr1qPcks_5ZZaHYDzcPdSm3mdSjD0Y_ivHwnIqCEq4lxU2jYQyqY3tJXoB4IHRIv4gLA4qrCGd5Vk-UhmiQ=s120" />
                <p class="c1name">YouTube IT</p>
                <p class="c2name">Chrome Extension</p>
              </div>
            </a>
          ...
          <div class="row rows rowpad w-100 m-auto">
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/vscode.webp" />
            ...
            <a class="bhdbutton dbox col"
              href="https://subarnabhd.notion.site/Fonts-8274776d9fea423c80e03f5ab3d52946?pvs=4" type="button"
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/fonts.webp" />
                <p class="c1name">Fonts</p>
                <p class="c2name">English & Nepali</p>
              </div>
            </a>
            <a class="bhdbutton dbox col"
              href="https://subarnabhd.notion.site/Icons-86d490e1f14d4b1fb0e330a50d8308b1?pvs=4" type="button"
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/icons.webp" />
                <p class="c1name">Icons</p>
                <p class="c2name">Develop & Design</p>
              </div>
            </a>
            <a class="bhdbutton dbox col"
              href="https://subarnabhd.notion.site/Colors-9fcadded44ba4eaf93433d904abdb3f7?pvs=4" type="button"
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/colors.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/shortcut.webp" />
            ...
            <a class="bhdbutton dbox col" href="https://mega.nz/folder/5E8XBS7A#pEC0WxTOCv93I-H4vc-EzA" type="button"
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/folder.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/office.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/wactivator.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/wstore.webp" />
          ...
          <div class="row rows rowpad w-100 m-auto">
            ...
            <a class="bhdbutton dbox col"
              href="https://subarnabhd.notion.site/Figma-90c1da50b3af48d8be800a832fcc5e3b?pvs=4" type="button"
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/figma.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/photoshop.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/illustrator.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/lightroom.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/premier.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/aftereffect.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/mediaencoder.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              type="button" target="_blank">
              <div class="cbutton">
                <img src="./image/tools/acrobat.webp" />
                <p class="c1name">Adobe Acrobat Pro DC</p>
                <p class="c2name">PDF Editor</p>
              </div>
            </a>
            <a class="bhdbutton dbox col"
              href="https://subarnabhd.notion.site/Adobe-Creative-Cloud-25515da0b17b4caa80a32648e0d6267b?pvs=4" type="button"
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/creativecloud.webp" />
                <p class="c1name"> Adobe Creative Cloud</p>
                <p class="c2name">Adobe</p>
              </div>
            </a>
            <a class="bhdbutton dbox col"
              ...
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/blender.webp" />
            ...
            <a class="bhdbutton dbox col"
              ...
              target="_blank">
              <div class="cbutton">
                <img src="./image/tools/davinci.webp" />
